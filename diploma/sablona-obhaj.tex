...
% Varianta A:
\usepackage[czech]{babel}             % Balíček pro sazbu různojazyčných dokumentů; kompilovat (pdf)latexem!
...
\frame{  %2.snimek
   ...
   % zde vlozit vlastni text k cilum (zadani) prace
		...
		\begin{itemize}
			\item Nastudovat\,\dots
			\item Popsat\,\dots
			\item Implementovat\,\dots
			\item Porovnat\,\dots
		\end{itemize}

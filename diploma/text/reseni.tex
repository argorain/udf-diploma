...
\label{sec:fsd}
Souborová struktura UDF je postavena na třech a později čtyřech deskriptorech, které se podílí na popisu a uložení dat. Jedná se o tyto deskriptory:
\begin{itemize}
    \item \textit{File Set Descriptor} (FSD)
    \item \textit{(Extended) File Entry} (FE)
...
XOR            1010
\end{verbatim}
\todo{Co dělám blbě? Sice to vyjde nenulové, ale neukáže mi to kde je chyba...}

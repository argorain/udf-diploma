...
\begin{enumerate}
    ...
    \item Spustí se referenční nástroj \texttt{udfct} a opět se porovnají výstupy. Pokud byla oprava úspěšná, médium by nemělo nyní vykazovat chyby.
\end{enumerate}
Tato metodika byla navržena pro potřeby vývoje nástroje a pro zajištění maximálního možného pokrytí případných chyb média (obzvláště u nahodile poškozených médií.) Zjednodušená verze tohoto testu byla implementována pro potřeby automatického testování. Ta je omezena pouze na testování vlastného nástroje bez rerefernce a testuje vůči předpokládaným návratovým hodnotám. V principu jde o vynechání kroků 2 a 6 z předchozí sekvence.
...
\begin{lstlisting}[frame=single,caption={Výsledek opravy poškozeného média programem \texttt{udffsck}},label=lst:udffsck-pass,basicstyle=\ttfamily\scriptsize, keywordstyle=\color{black}\bfseries\underbar,nolol,numbers=left,texcl=false]
...
[ERROR] (2017-01-16-191632.webm) Tag Serial Number differs.
(2017-01-16-191632.webm) Tag Serial Number was fixed.
[ERROR] (2017-01-16-191632.webm) File size mismatch. Probably unfinished file write.
Removing unfinished file...
(2017-01-16-191632.webm) Unifinished file was removed.
...
[ERROR] 19203 blocks is unused but not marked as unallocated in Free Space Table.
[ERROR] Correct free space: 3272846
[ERROR] 242184 blocks is unused but not marked as unallocated in SBD.
...
[ERROR] Opened integrity type. Some writes may be unfinished.
[ERROR] Number of files or directories is not corresponding to counted number
[ERROR] Free Space table is not corresponding to reality.
PD SBD recovery was successful.
LVID recovery was successful.
All done
\end{lstlisting}
\begin{figure}[] 
    \centering

...
.4 udffsck.8\DTcomment{Manuálová stránka k nástroj \texttt{udffsck}}.
.4 fsck.udf.8\DTcomment{Alias na udffsck.8}.
.4 html\DTcomment{Dokumentace v html podobě vygenerovaná nástrojem Doxygen}.
.5 index.html\DTcomment{Vstupní bod dokumentace}
.3 Doxyfile.
.3 ChangeLog.
...
.2 demo.avi\DTcomment{Záznam demonstrující činnost kontroly a opravy média}.
}

...
.4 \detokenize{ecma_119.h}\DTcomment{Soubor s vybranými hlavičkami standardu ECMA-119.}.
.4 main.c\DTcomment{Hlavní soubor programu. Obsahuje kromě funkce main také detekci VRS.}.
.4 Makefile.am.
.4 options.c\DTcomment{Parser vstupních parametrů a nápověda.}.
.4 options.h.
.4 test.c\DTcomment{Zdrojový soubor pro unit-testy.}.
